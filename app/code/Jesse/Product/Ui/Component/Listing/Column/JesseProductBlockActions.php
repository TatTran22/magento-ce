...
namespace Jesse\Product\Ui\Component\Listing\Column;
 ...
 */
class JesseProductBlockActions extends Column
{
    /**
     * Entity name.
     */
    private const ENTITY_NAME = 'JesseProduct';

    /**
     * Url paths.
     * #@+
     */
    private const EDIT_URL_PATH = 'jesse_product/jesseproduct/edit';
    private const DELETE_URL_PATH = 'jesse_product/jesseproduct/delete';
    /** #@- */
    ...
    public function prepareDataSource(array $dataSource): array
    {
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as &$item) {
                if (isset($item[JesseProductInterface::JESSE_PRODUCT_ID])) {
                    $entityName = static::ENTITY_NAME;
                    $urlData = [JesseProductInterface::JESSE_PRODUCT_ID => $item[JesseProductInterface::JESSE_PRODUCT_ID]];
